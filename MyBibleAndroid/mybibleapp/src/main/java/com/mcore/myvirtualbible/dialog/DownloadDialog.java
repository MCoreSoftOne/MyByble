...
public class DownloadDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Spinner versionsSpinner = (Spinner) findViewById(R.id.spn_bbl_available);
			...
			chkUseExternalStorage
					.setOnCheckedChangeListener(new OnCheckedChangeListener() {
						...
						public void onCheckedChanged(CompoundButton buttonView,
							...
							if (isChecked) {
								boolean hasPermission = BibleUtilities.verifyReadWriteStoragePermission(ctx, MyBibleConstants.PERMISSIONS_REQUEST_STORAGE__CHANGE_STORAGE_TYPE);
								if (!hasPermission) {
									return;
								}
							}
	...
	private void downloadTranslation(TranslationDTO selectedItem) {
		if (MyBibleConstants.MYBIBLE_DEVELOPER_MODE && MyBibleConstants.MYBIBLE_DEVELOPER_MODE_FULL_DOWNLOAD) {
	...
	protected void onTranlationChange() {
		...
		final Spinner translationsSpinner = (Spinner) findViewById(R.id.spn_bbl_available);
		final Spinner languagesSpinner = (Spinner) findViewById(R.id.spn_language);
	...
	private void updateLangSpinner() {
		...
		final Spinner langSpinner = (Spinner) findViewById(R.id.spn_language);
	...
	private void updateTranslationSpinner() {
		final Spinner translationSpinner = (Spinner) findViewById(R.id.spn_bbl_available);
